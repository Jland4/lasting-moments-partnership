            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="flex-1">
                <p className="text-xl md:text-2xl text-foreground leading-relaxed font-serif italic">
                  "A father records messages for his daughter's wedding day, her college graduation, and the birth of her first child. Each message is delivered privately, years apart, exactly when intended."
                </p>
              </div>
...
export default FamiliesExamplesSection;
