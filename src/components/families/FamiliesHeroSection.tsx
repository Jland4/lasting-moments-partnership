    ...
    <section className="relative min-h-[80vh] flex items-center hero-gradient overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay-1">
          ...
          {/* Visual guidance note - for design reference */}
          {/* 
            VISUAL GUIDANCE:
            - Imagery: Calm, personal, timeless, natural
            - Use soft natural light
            - Real people (not models)
            - Quiet, intimate moments
            - One or two individuals per frame
            - Neutral or warm backgrounds
            
            AVOID:
            - Funeral imagery, caskets, services
            - Overly joyful or staged scenes
            - Stock-photo smiles
            - Technology-forward visuals
          */}
